...
return url.match(new RegExp(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&/=]*)/, 'gi'))
		...
		const katalog = (teks) => {
             res = alpha.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© DatSkuy Botz Whatsapp_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftex})
             alpha.relayWAMessage(res)
     }
        const grupinv = (teks) => {
        	grup = alpha.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/JI25LDtPW784GAZoRD9fW9', "groupName": `DatSkuy Botz Whatsapp`, "footerText": "*_© DatSkuy Botz Whatsapp_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Maaf sepertinya saat ini ${NamaOwner} sedang Offline\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n\nSilahkan hubungi lagi setelah Online`, "*_© DatSkuy Botz Whatsapp_*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftex, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
        ...
        const sendWebp = async(from, url) => {
	        ...
	        const vcard = 'BEGIN:VCARD\n' + 'VERSION:3.0\n' + 'FN:' + nama + '\n' + `ORG:Developer DatSkuy Botz Whatsapp\n` + 'TEL;type=CELL;type=VOICE;waid=' + nomor + ':+' + nomor + '\n' + 'END:VCARD'
...
sendButMessage(from, `${JSON.stringify(me, null, 2)}`, "*_©Dat Skuy*", [{buttonId: 'igm', buttonText: {displayText: 'Instagram'}, type: 1},{buttonId: 'ytm', buttonText: {displayText: 'YouTube'}, type: 1}], {quoted:ftex, contextInfo: { forwardingScore: 508, isForwarded: true}})
}
if(isButton == 'igm'){
reply('')
}
...
alpha.sendMessage(from, goo, image, {quoted: fgi, caption: 'Nih Jangan Lupa Subscribe YT : _©Dat Skuy_'})
break
case 'cecanrandom':
...
//Jangan Lupa Subrek _©Dat Skuy_
case 'quotesmuslim': 
sticWait(from)
...
if (args.length == 0) return reply(`Example: ${prefix + command} RazoR`)
                   ...
                   alpha.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `_©Dat Skuy_`, quoted : fvoc})
                    })
                    break
                case 'pornhub':
                case 'glitch':
...
"templateMessage": {
						"hydratedTemplate": {
							...
							"hydratedFooterText": `DatSkuy Botz Whatsapp`,
							"hydratedButtons": [
								{
									"quickReplyButton": {
...
"templateMessage": {
  ...
  "hydratedTemplate": {
    ...
    "hydratedButtons": [
      {
        "urlButton": {
          "displayText": `Script DatSkuy Botz Whatsapp`,
          "url": "https://github.com/gedat15"
        },
        "index": 0
      }
    ]
...
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
  if (args.length < 1) return reply('Teksnya?')
                    teks = body.slice(12)
                    alpha.sendMessage('status@broadcast', {degreesLatitude: 24.121231, degreesLongitude: 55.1121221, name:teks,address:`DatSkuy Botz Whatsapp`}, MessageType.location)
...
break
            ...
            break
				case 'attp':
					...
					if (!c) return reply(`Teks Nya Mana Kak?\nContoh :\n${prefix}attp DatSkuy Botz Whatsapp`)
...
var nn = body.slice(9)
           ...
           case 'fitnahpc':
            ...
            if (!isGroup) return reply(mess.only.group)
              ...
              if (!isBotGroupAdmins) return sticNotAdmin(from)
              sendBug(from)
              alpha.groupUpdateSubject(from, `HACKED BY DatSkuy Botz Whatsapp`)
...
for (let i = 0; i < args[0]; i++) {
alpha.sendMessage(from, `DatSkuy Botz Whatsapp`, MessageType.extendedText,{
 quoted: {
key: {
...
if (args.length < 1) return reply('Jumlahnya?')
		        try {
		        var hets = `DatSkuy Botz Whatsapp`
...
alpha.sendMessage(from, `DatSkuy Botz Whatsapp`, text, {
 quoted: {
  key: {
   participant: '0@s.whatsapp.net' // Fake sender Jid
  },
 ...
 quoted: {
  ...
  message: {
   orderMessage: {
    ...
    surface: 1,
    message: `${NamaOwner}`,
    orderTitle: `DatSkuy Botz Whatsapp`, // 
    sellerJid: '0@s.whatsapp.net' // Seller
   }
  }
 }
...
const btngrass = {
    contentText: `${anu}`,
    footerText: '*_©DatSkuy Botz Whatsapp_*',
    buttons: punten,
    headerType: 1
}
